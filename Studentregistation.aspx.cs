    ...
    public partial class Studentregistation : System.Web.UI.Page
    {
        ...
        protected void ButtonRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String Studentinsertquary = "insert into Student (UserId,Field,SchoolName,Age) values (@UID,@Field,@SchoolName,@Age)";
                SqlCommand com2 = new SqlCommand(Studentinsertquary, con);
